...
author: Nicole Black, Kayla Xu, Erika Li, Jeanne Revilla
date: 07/13/22
updated: 09/13/2025 
---
### Secure copy (scp) this file to your qbio_490_name repository. DO NOT EDIT IN fa25_course_materials! ###

As a reminder: here are the steps to put this assignment onto your CARC so you can work on it yourself! 
1. Open your terminal and cd into the fa25_course_materials directory
2. Use git pull to get any updates from Github onto your local machine. 
3. Copy this week’s content folder into your qbio_490_name folder using 
scp -r [name of folder] [absolute or relative path to your qbio_490_name folder]
4. cd into your qbio_490_name folder
You can use an absolute path OR a relative path here.
5. Log onto the CARC transfer nodes by typing 
sftp username@hpc-transfer1.usc.edu 
and inputting your password when prompted.
6. cd into your 490_cluster folder 
7. Add this week’s folder using put -r [folder name]
8. Type exit to close the connection.
9. Open a new CARC session and start working on your homework! The copied folder should show up in the lower right pane in Rstudio. You can use ctrl+S to save and return to CARC at any time.
...
Don't run this! Usually, you will use setwd() in an R Script, not an R Notebook
```{r 2.2}
## DON'T RUN THIS!!! 
...
knitr::opts_knit$set(root.dir = normalizePath("/PATH/TO/DIRECTORY")) #TODO: edit this to show your path
```
...
## TODO: Create a new variable my_var to store anything you choose:

my_var <- "welcome to 490!"
print(my_var)
```
...
```{r Exercise 5.2}
"cat" == "cat" & "dog" == "dog" # TODO: make a prediction: 
"cat" == "cat" & "fish" == "hamster" # TODO: make a prediction: 

1 < 2 | 3 < 1 # TODO: make a prediction: 
1 < 2 | 3 < 5 # TODO: make a prediction: 
